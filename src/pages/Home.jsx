  ...
  const services = [
    {
      ...
      description:
        "Your all-in-one access point to manage your account, track updates, and enjoy personalized city services.",
    ...
    },
    {
      ...
      description:
        "Easily submit feedback or complaints and track their status in real time",
      color: "rgb(172, 65, 67)",
    },
    {
      ...
      description:
        "Monitor usage, pay bills, and report electricity, water, or internet issues",
      color: "rgb(209, 169, 99)",
    },
  ];
    ...
    <>
      ...
      <div className="container grid  grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 py-20">
        <div>
          ...
          <p className="text-gray-700 text-lg mb-8 leading-relaxed">
            Experience a revolutionary smart city platform that honors the
            grandeur of Ancient Egypt while delivering cutting-edge digital
      ...
      <div className="container py-10 md:py-16 ">
        <div className="text-center">
          <h3 className="text-3xl sm:text-4xl text-[rgb(19,17,18)] mb-4">
            Core Services
          </h3>
          <div className="w-24 h-1 bg-gradient-to-r from-[rgb(209,169,99)] to-[rgb(172,65,67)] mx-auto rounded-full" />
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Comprehensive digital services designed to enhance your urban living
            experience
          </p>
        </div>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              ...
              <h4 className="text-xl font-semibold text-[rgb(19,17,18)] mb-2">
                {service.title}
              </h4>
      ...
      <div className="container py-10 md:py-8 ">
        <div className=" bg-gradient-to-l from-[rgb(209,169,99)]/70 to-[rgb(172,65,67)] to-[rgb(209,169,99)]/30 text-center max-w-7xl mx-auto p-6 sm:p-8  border border-[rgb(209,169,99)]/30 shadow-md shadow-black/20 rounded-2xl ">
          ...
          <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
            Join thousands of citizens already enjoying seamless digital
            services
          </p>
